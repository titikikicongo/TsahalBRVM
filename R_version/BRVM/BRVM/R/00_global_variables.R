...
globalVariables(
    names = c('.indexes', '.sectors', 'Box.test', 'Close', 'Countries', 'Date', 'High', 'Low', 'Open', 'POST',
              'Sector', 'Ticker', 'Volume', 'ad.test', 'adf.test', 'arrange', 'as.xts', 'color_tile',
